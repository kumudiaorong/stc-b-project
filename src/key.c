...
static XDATA sys_callback_t key_callback_table[__KEY_CNT][2];
static XDATA uint8_t key_states;
static XDATA uint8_t key_state[__KEY_CNT] = {0};
...
#undef __KEY_BY_INT
#endif
// msg: 0x00 0x00 0x00 0x00(event1 event2 event3 event4)
